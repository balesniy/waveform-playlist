...
ee.on("pitchCorrectionStart", function() {
  displayLoadingData("Wait for pitch correction");
});
ee.on("pitchCorrectionEnd", function() {
  displayLoadingData("done pitch correction");
